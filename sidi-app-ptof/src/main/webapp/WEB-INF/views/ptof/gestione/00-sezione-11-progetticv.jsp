<div ng-controller="GestioneSezioneCtrl as gestioneRootSezioneCtrl">
	...
	<div class="content" ng-controller="GestioneSezione-11-GestioneProgettiCVCtrl as gestioneSezioneCtrl">
	...
	<div ng-repeat="componente in modelGestioneSezione.sezione.componenti"  >
		   ...
		   <div class="block-info"  ng-if = "'S_PROGETTI_CURRICULARI'==componente.tipoComponente"  class="block-info-noborder" > 	
			                   ...
			                   <form role="form" class = "form-horizontal">
										...
										<label class= "col-sm-3 col-xs-3 control-label"> Ambito	 </label>
										 <div class="col-sm-9 col-xs-9" > 
										   <bsselectpicker data-bid="item1_ambito" data-show = "vm.tabella1.dialogAction=='I'"  data-items="vm.form.ambitiL" data-selected="vm.tabella1.newItem.ambito"></bsselectpicker>
										    <textarea msd-elastic="" ng-if="!(vm.tabella1.dialogAction=='I')"  rows="5"    readonly="readonly"  ng-model = "vm.tabella1.newItem.ambito.label"    class="form-control" ></textarea>
										 </div>			   
									 </div>			   
 
									<div class="form-group row"  ng-if = "vm.tabella1.newItem.ambito!=null" >  
										<label class= "col-sm-3 col-xs-3 control-label"> Tipologia Progetto	 </label>
										 <div class="col-sm-9 col-xs-9" > 
										   <bsselectpicker  data-bid="item1_tipologiaProgetto" data-show = "vm.tabella1.dialogAction=='I' && vm.tabella1.newItem.ambito!=null"  data-items="vm.form.tipologiaProgettoL" data-selected="vm.tabella1.newItem.tipologiaProgetto"></bsselectpicker>
										   <textarea  msd-elastic=""  ng-if="!(vm.tabella1.dialogAction=='I')" rows="5"    readonly="readonly"  ng-model = "vm.tabella1.newItem.tipologiaProgetto.label"    class="form-control"  placeholder="inserisci" ></textarea>
										 </div>			   
									 </div>			   
									...
									<div class="form-group row" >  
										<label class= "col-sm-3 col-xs-3 control-label"> Risorse Finanziare necessarie </label>
										 <div class="col-sm-3 col-xs-3" > 
										   <input  ng-readonly = "vm.tabella1.dialogAction=='V'" fa-numeric="amount2DecimalType" id="date1_RisorseFinanziareNecessarie"   maxlength="10" type="text"    fa-model = "vm.tabella1.newItem.risorseFinanziareNecessarie"    class="form-control" placeholder="inserisci"></input>
										 </div>			   
									 </div>	
