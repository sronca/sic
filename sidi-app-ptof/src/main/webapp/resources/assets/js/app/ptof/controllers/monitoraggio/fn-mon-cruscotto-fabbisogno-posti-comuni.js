...
angular.module('ptof.controllers.monitoraggio.fabbissognoPostiComuni', [
  'ptof.commons.services',                                            
  'ptof.directives',
  'base64'
]).controller('MonitoraggioFabbisognoPostiComuniCtrl', function ($scope, $window ,$timeout, $base64, ptofCommonsServicesFactory,monitoraggioServicesFactory) {
	console.log('MonitoraggioFabbisognoPostiComuniCtrl->');
   ...
   $scope.scaricaReport = function() {	    
	   ...
	   if ($scope.vm.form.regione != undefined){
	    ...
	    console.log('MonitoraggioFabbisognoPostiComuniCtrl->scaricaReport');
	    monitoraggioServicesFactory.downloadFabbisognoPostiComuni(form);   
   }
