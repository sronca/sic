...
angular.module('ptof.controllers.monitoraggio.fabbissognoTotaleOrganica', [
  'ptof.commons.services',                                            
  'ptof.directives',
  'base64'
]).controller('MonitoraggioFabbisognoTotaleOrganicaCtrl', function ($scope, $window ,$timeout, $base64, ptofCommonsServicesFactory,monitoraggioServicesFactory) {
	console.log('MonitoraggioFabbisognoTotaleOrganicaCtrl->');
   ...
   $scope.scaricaReport = function() {	    
	   ...
	   console.log('MonitoraggioFabbisognoTotaleOrganicaCtrl->scaricaReport');
	   monitoraggioServicesFactory.downloadFabbisognoTotaleOrganica(form);   
   }
