 ...
 */
public class ComponenteFabbisognoPostiPotenziamentoMMDTO extends  ComponenteBaseListDTO<FabbisognoPostiPotenziamentoMMDTO>   {
	...
	public TIPO_COMPONENTE getTipoComponente() {
		...
		return TIPO_COMPONENTE.S_FABBISOGNO_POSTI_POTENZIAMENTO_MM;
	}
