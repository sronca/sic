 ...
 * RF025
 */
public class ComponenteOrganigrammaAltriRuoliDTO extends  ComponenteBaseListDTO<OrganigrammaDTO>   {
	...
	public TIPO_COMPONENTE getTipoComponente() {
		...
		return TIPO_COMPONENTE.S_ORGANIZZAZIONE_RISORSE_ALTRI_RUOLI;
	}
