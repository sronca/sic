 ...
 */
public class ComponenteFabbisognoPostiCattedreEEAADTO extends  ComponenteBaseListDTO<FabbisognoPostiCattedreDTO>   {
	...
	public TIPO_COMPONENTE getTipoComponente() {
		...
		return TIPO_COMPONENTE.S_FABBISOGNO_POSTI_CATTEDRE_AA_EE;
	}
