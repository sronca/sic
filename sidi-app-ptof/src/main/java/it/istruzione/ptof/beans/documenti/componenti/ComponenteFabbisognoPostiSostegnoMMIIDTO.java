 ...
 */
public class ComponenteFabbisognoPostiSostegnoMMIIDTO extends  ComponenteBaseListDTO<FabbisognoPostiSostegnoMMIIDTO>   {
	...
	public TIPO_COMPONENTE getTipoComponente() {
		...
		return TIPO_COMPONENTE.S_FABBISOGNO_POSTI_SOSTEGNO_MMII;
	}
