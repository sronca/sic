 ...
 */
public class ComponenteFabbisognoPostiPotenziamentoEEAADTO extends  ComponenteBaseListDTO<FabbisognoPostiPotenziamentoEEAADTO>   {
	...
	public TIPO_COMPONENTE getTipoComponente() {
		...
		return TIPO_COMPONENTE.S_FABBISOGNO_POSTI_POTENZIAMENTO_AA_EE;
	}
