...
/*
  Sezione 13 - RF042– Fabbisogno di posti e cattedre
  per le secondarie I e II 
 */
public class ComponenteFabbisognoPostiCattedreMMDTO extends  ComponenteBaseListDTO<FabbisognoPostiCattedreMMDTO>   {
	...
	public TIPO_COMPONENTE getTipoComponente() {
		...
		return TIPO_COMPONENTE.S_FABBISOGNO_POSTI_CATTEDRE_MM;
	}
