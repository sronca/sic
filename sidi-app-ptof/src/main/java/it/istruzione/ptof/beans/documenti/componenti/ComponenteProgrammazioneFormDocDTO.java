 ...
 */
public class ComponenteProgrammazioneFormDocDTO extends  ComponenteBaseListDTO<ProgrammazioneFormDTO>   {
	...
	public TIPO_COMPONENTE getTipoComponente() {
		...
		return TIPO_COMPONENTE.S_PROGRAMMAZIONE_FORMAZIONE_DOC;
	}
