...
/**
 * @author mcatanzaro RF020– Progetti curricolari usato SOLO per caricare la
 *         form del requisito i singoli items CRUD vengono salvati atomicamente
 *         e non viene inviato tutto l'oggetto in salvataggio
 * 
 */
public class ComponenteProgettiCurriculariDTO extends ComponenteBaseListDTO<AmbitiProgettiDTO> {
