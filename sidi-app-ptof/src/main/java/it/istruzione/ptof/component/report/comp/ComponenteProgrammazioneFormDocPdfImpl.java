...
public class ComponenteProgrammazioneFormDocPdfImpl  implements ComponentePdf<ComponenteProgrammazioneFormDocDTO> {
 	
	@Override
	public void load(ComponenteProgrammazioneFormDocDTO comp, Document document, PdfWriter writer) throws Exception {
