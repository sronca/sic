...
@Component
public class ComponenteObbiettiviPrioritariAltriPdfImpl implements ComponentePdf<ComponenteObbiettiviPrioritariAltriDTO> {

	 
	@Override
	public void load(ComponenteObbiettiviPrioritariAltriDTO comp, Document document, PdfWriter writer) throws Exception {
