...
public class ComponenteProgrammazioneFormTecPdfImpl  implements ComponentePdf<ComponenteProgrammazioneFormTecDTO> {
 	
	@Override
	public void load(ComponenteProgrammazioneFormTecDTO comp, Document document, PdfWriter writer) throws Exception {
