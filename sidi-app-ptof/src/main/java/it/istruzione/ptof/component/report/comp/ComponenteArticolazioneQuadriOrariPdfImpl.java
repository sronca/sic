...
public class ComponenteArticolazioneQuadriOrariPdfImpl implements ComponentePdf< ComponenteArticolazioneQuadriOrariDTO> {
	...
	public void load(ComponenteArticolazioneQuadriOrariDTO comp, Document document, PdfWriter writer)
		...
		for ( ArticolazioneQuadriOrariDTO progetto :comp.getItems() ){
			...
			createTab1(tableInner ,comp , helper, j, progetto);
	...
	public void createTab1(PdfPTable cornice ,ComponenteArticolazioneQuadriOrariDTO comp, PtofComponentePdfHelper helper, int j, ArticolazioneQuadriOrariDTO progetto) throws DocumentException {
