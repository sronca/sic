...
public class ComponenteOrganigrammaPdfImpl  implements ComponentePdf<ComponenteOrganigrammaDTO>{

	@Override
	public void load(ComponenteOrganigrammaDTO componete, Document document, PdfWriter writer) throws Exception {
		 int j=0;
