...
public class ComponenteProgrammazioneFormAusPdfImpl  implements ComponentePdf<ComponenteProgrammazioneFormAusDTO> {
 	
	@Override
	public void load(ComponenteProgrammazioneFormAusDTO comp, Document document, PdfWriter writer) throws Exception {
