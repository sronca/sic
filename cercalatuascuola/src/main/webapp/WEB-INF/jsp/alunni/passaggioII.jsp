...
<html>
    ...
    <body data-codscuut="${scuola.codScuUt}" data-desnomscu="${scuola.desNomScuNorm}">
                            ...
                            <article class="sc-internal-content sc-table-cell">
                                ...
                                <div class="sc-cols">
                                    <div class="sc-col-full">
                                        <p class="sc-center">
                                        	<strong>
                                        		<span id="chart-rav24c5-title"></span>
                                        	</strong>
                                        </p>
                                        <div class="sc-chart" id="sc-bar-chart-rav24c5"></div>
                                        <p class="sc-note" id="chart-rav24c5-note"></p>
					                	<div class="chart-explain chart-explain-clear">
					                		<p class="sc-note ellips" data-origwidth="" id="chart-rav24c5-approfondisci"></p>
					                	</div>                                        
                                    </div>
                                </div>
                                <div class="sc-cols">
        ...
        <script src="<c:url value="/resources/js/grafici/alunni/rav24c5.js"/>"></script>
        <script src="<c:url value="/resources/js/grafici/alunni/rav24c2II.js"/>"></script>
        <script src="<c:url value="/resources/js/grafici/alunni/rav24c3II.js"/>"></script>        
