...
<html>
    ...
    <body data-codscuut="${scuola.codScuUt}" data-desnomscu="${scuola.desNomScuNorm}">
					          ...
					          <article class="sc-internal-content sc-table-cell">
					            ...
					            <div class="sc-cols">
					              <div class="sc-col-full">
					                <p class="sc-center"><strong><span id="chart-diplomati-esaminati-title"></span></strong></p>
					                <div class="sc-chart" id="sc-bar-chart-diplomati-esaminati"></div>
					                <p class="sc-note" id="chart-diplomati-esaminati-note"></p>
				                	<div class="chart-explain chart-explain-clear">
				                		<p class="sc-note ellips" data-origwidth="" id="chart-diplomati-esaminati-approfondisci"></p>
				                	</div>					                
					              </div>
					            </div>
					            <div class="sc-cols">
					              <div class="sc-col-full">
					                <p class="sc-center"><strong><span id="chart-distribuzione-votazioni-esame-title"></span></strong></p>
					                <div class="sc-chart" id="sc-pie-chart-distribuzione-votazioni-esame"></div>
					                <p class="sc-note" id="chart-distribuzione-votazioni-esame-note"></p>
				                	<div class="chart-explain chart-explain-clear">
				                		<p class="sc-note ellips" data-origwidth="" id="chart-distribuzione-votazioni-esame-approfondisci"></p>
				                	</div>					                
					              </div>
					            </div>
					          </article>
        ...
        <script src="<c:url value="/resources/js/grafici/alunni/diplomatiEsaminati.js"/>"></script>
        <script src="<c:url value="/resources/js/grafici/alunni/distribuzioneVotazioniEsame.js"/>"></script>        
