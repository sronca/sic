...
<script src="<c:url value="/resources/js/jquery.cookieconsent.js"/>"></script>
<script>
	window.cookieconsent_options = {
		...
		"dismiss":"X",
		"scrollaccept": true,
		"link":"http://cercalatuascuola.istruzione.it/cercalatuascuola/informativa_cookie/",
		"theme":"http://cercalatuascuola.istruzione.it/cercalatuascuola/resources/css/light-bottom.css"
	};
</script>
	...
	<section class="sc-main">
		...
		<div class="sc-main-content">
			...
			<nav class="sc-search-nav">
				<ul>
					<li class="active"><a class="sc-icon-def"
						data-tab="sc-search-def" href="javascript:void(0);"
						title="Ricerca rapida"> <span>Ricerca rapida</span>
					</a></li>
					<li><a class="sc-icon-pos" data-tab="sc-search-pos"
						href="javascript:void(0);" title="Ricerca per posizione"> <span>Ricerca
								per posizione</span>
					</a></li>
					<li><a class="sc-icon-adv" data-tab="sc-search-adv"
						href="javascript:void(0);" title="Ricerca avanzata"> <span>Ricerca
								avanzata</span>
					</a></li>
				</ul>
			</nav>
			...
			<section class="sc-search-content">
				...
				<article class="sc-search-def active">
					...
					<form:form action="/cercalatuascuola/ricerca/risultati"
						...
						id="formRicercaRapida">
						<fieldset>
							<div class="sc-form-content">
								<div class="sc-fields">
									<div class="sc-field sc-field-2-3">
										<input type="text" name="rapida" id="rapida"
											spellcheck="false" placeholder="Ricerca rapida"
											value="${voRicerca.rapida}" class="required" />
									</div>
					...
					<div class="sc-box-home-info">
						<p>Scuola in Chiaro ti permette di cercare le scuole,
							esaminare e confrontare le loro caratteristiche</p>
						<a href="/cercalatuascuola/approfondisci">Approfondisci</a>
					</div>
				</article>
				...
				<article class="sc-search-adv">
					...
					<form:form action="/cercalatuascuola/ricerca/risultati"
						method="get" commandName="voRicerca">
						<fieldset>
							<div class="sc-form-content">
								<div class="sc-fields">
									<div class="sc-field sc-field-1-2">
										...
										<div class="sc-select">
											<form:select path="codiceRegione"
												...
												items="${listaRegioni}" cssClass="required" />
										</div>
									</div>
								...
								<div class="sc-fields">
									<div class="sc-field sc-field-1-2" id="comune_container">
										<label>Comune </label>
										<div class="sc-select">
											<form:select path="codiceComune" title="Selezionare comune" />
										</div>
									</div>
									<div class="sc-field sc-field-1-2">
										<label>Tipo di istruzione </label>
										<div class="sc-select">
											<form:select path="codiceOrdine" id="codiceOrdineAvanzata"
												title="Selezionare l'ordine scuola"
												onchange="javascript:caricaTipologia(this.value,'Avanzata');"
												items="${listaOrdini}" cssClass="required" />
										</div>
									</div>
								</div>
								...
								<div class="sc-fields"
									id="tipologiaStataleNuovoOrdinamento_containerAvanzata">
									<div class="sc-field">
										<label>Scuola secondaria di II grado
											${msgANNO_SCOLASTICO_INDIRIZZI_STUDIO}</label>
										<div class="sc-select">
								...
								<div class="sc-fields" id="settoreScuola_containerAvanzata">
									<div class="sc-field">
										...
										<div class="sc-select">
											<form:select id="codiceSettoreScuolaAvanzata"
								...
								<div class="sc-fields" id="biennio_triennio_containerAvanzata">
									<div class="sc-field sc-field-1-2">
										...
										<div class="sc-cont-check">
											<div class="sc-cont-check-cel">
												<input type="radio" class="radioBiennioTriennioAvanzata"
													id="radioBiennioTriennioAvanzata"
													name="radioBiennioTriennio" value="Biennio"
													onclick="javascript:caricaIndirizzoStudio('Avanzata');"
													style="display: block" checked="checked" />
											</div>
										</div>
									</div>
									<div class="sc-field sc-field-1-2">
										...
										<div class="sc-cont-check">
											<div class="sc-cont-check-cel">
												<input type="radio" class="radioBiennioTriennioAvanzata"
													id="radioBiennioTriennioAvanzata"
													name="radioBiennioTriennio" value="Triennio"
													onclick="javascript:caricaIndirizzoStudio('Avanzata');"
													style="display: block" />
											</div>
										</div>
								...
								<div class="sc-fields" id="indirizzoStudio_containerAvanzata">
									<div class="sc-field">
										<label id="indirizzo_studio_qualificaAvanzata">Indirizzo
											di studio</label>
										<div class="sc-select">
											<form:select id="codiceIndirizzoAvanzata"
								...
								<div class="sc-fields" id="codiceCFP_containerAvanzata">
									<div class="sc-field">
										<label>Percorso</label>
										<div class="sc-select">
											<form:select id="codiceCFPPercorsoAvanzata"
								...
								<div class="sc-fields" id="settoreCFP_containerAvanzata">
									<div class="sc-field">
										<label>Settore</label>
										<div class="sc-select">
											<form:select id="codiceCFPSettoreAvanzata"
												path="codiceCFPSettore" title="Selezionare settore"
								...
								<div class="sc-fields" id="indirizzoCFP_containerAvanzata">
									<div class="sc-field">
										<label>Indirizzo di studio</label>
										<div class="sc-select">
											<form:select id="codiceCFPIndirizzoAvanzata"
								...
								<div class="sc-fields"
									id="tempiScuolaScuolaPrimaria_containerAvanzata">
									<div class="sc-field">
										<label>Tempi Scuola primaria</label>
										<div class="sc-select">
											<form:select id="codiceTempoPrimariaAvanzata"
												path="codiceTempoPrimaria" title="Selezionare Tempi Scuola" />
										</div>
									</div>
								</div>
								<div class="sc-fields"
									id="tempiScuolaScuolaSecondaria1Grado_containerAvanzata">
									<div class="sc-field">
										<label>Tempi Scuola secondaria di I grado</label>
										<div class="sc-select">
											<form:select id="codiceTempoSecondaria1GradoAvanzata"
								...
								<div class="sc-fields" id="indirizzoMusicale_containerAvanzata">
									<div class="sc-field">
										...
										<div class="sc-cont-check">
											<div class="sc-cont-check-cel">
												<input type="checkbox" id="checkIndirizzoMusicaleAvanzata"
													name="checkIndirizzoMusicale" value="S" />
											</div>
										</div>
									</div>
								...
								<div class="sc-fields">
									<div class="sc-field">
										<label>Denominazione</label> <input class="campo_testo"
											type="text" name="denominazione" id="denominazioneAvanzata" />
									</div>
								</div>
								<div class="sc-fields">
									<div class="sc-field">
										<label>Codice meccanografico</label> <input
											class="campo_testo" type="text" name="codMecc" size="30"
											maxlength="10" id="codMeccAvanzata" />
									</div>
								</div>
							</div>
							<div class="sc-submit">
