      ...
      <div  class="sc-table-table sc-external-box">
        <div class="sc-table-row sc-external-box">
          ...
          <article class="sc-internal-content sc-table-cell">
            <div class="sc-cols">
              <h2>Progettazione PON-FSER 2007/2015</h2>
              <c:if test="${not empty lista}">
	              <table class="sc-table sc-table-standard">
	                <thead>
	                  <tr>
	                    <th><span>Codice di progetto</span></th>
	                    <th><span>Gare effettuate</span></th>
	                    <th><span>Breve descrizione del lavoro/laboratorio realizzato</span></th>
	                    <th><span>Benefici per l'istituto</span></th>
	                ...
	                <tbody>
	                	<c:forEach items="${lista}" var="riga">
	                  		<tr>
			                    ...
			                    <td data-col-2="Gare effettuate" class="sc-col-2">${riga.flgGare}/16</td>
			                    <td data-col-3="Breve descrizione del progetto" class="sc-col-3">${riga.descProgFormat}</td>
			                    <td data-col-4="Benefici per l'istituto" class="sc-col-4">${riga.descBenefici}</td>
