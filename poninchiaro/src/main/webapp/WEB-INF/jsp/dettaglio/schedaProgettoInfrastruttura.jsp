          ...
          <div class="row">
            ...
            <div class="gray-block page-detail page-separate-columns">
				<p class="title-grey-detail">
					<a href="<c:url value="/istituti/${scuola.codiceMeccanograficoLowerCase}/${scuola.desNomScuNorm}/progetti/${codTipFon}"/>">Progetti infrastruttura</a> > Scheda Progetto
				</p>
                	...
                	<div class="box-single-white last-box radius-bottom-left space-mobile-top">
                		<div class="box-center-sb">
							...
							<ul class="item-list list-simple">
								...
								<li><span class="key">Numero interventi:</span> <span class="value"><strong>${datiProg.numInterventi}</strong></span></li>
								...
								<li class="r"><span class="key">Fondo:</span> <span class="value"><strong>${datiProg.codTipoFondo}</strong></span></li>
							</ul>
						</div>
                	</div>
